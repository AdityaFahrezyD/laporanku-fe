...
export default function AttachmentPicker({ file, disabled, onChange, onRemove, onPreparing, index }) {
  ...
  return <div className="rounded-xl border border-primary/10 p-3">
    <Placeholder src={file ? preview : ''} alt={file?.name || ''} label={'Bukti transaksi ' + (index + 1)} description="JPG, PNG, WebP, AVIF · maksimal 5 MB / 10 juta piksel" imageClassName="!object-contain" />
